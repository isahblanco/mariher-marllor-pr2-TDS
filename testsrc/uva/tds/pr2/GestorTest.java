...
class GestorTest{
	...
	void testGestor() {
		...
		fail("Falla debido a evitar error en ejecucion");
	}
	...
	void testGetGestorCorreosPorFecha() {
		...
		assertEquals(gestor.getGestorCorreosPorFecha(LocalDate.of(2020, 9, 19)), gestor2);
	}
	...
	void testGetGestorCorreosEntreFechas() {
		...
		assertEquals(gestor.getGestorCorreosEntreFechas(LocalDate.of(2020, 9, 15), LocalDate.of(2020, 10, 15)), gestor2);
	}
	...
	void testGetGestorCorreosPorCategoria() {
		...
		assertEquals(gestor.getGestorCorreosPorCategoria(EnumCategoria.enviado), gestor2);
	}
	...
	void testGetGestorCorreosPorCategoriaYFecha() {
		...
		assertEquals(gestor.getGestorCorreosPorCategoriaYFecha(EnumCategoria.enviado,LocalDate.of(2020, 9, 19)), gestor2);	
	}
	...
	void testGetGestorCorreosPorCategoriaEntreFechas() {
		...
		assertEquals(gestor.getGestorCorreosPorCategoriaEntreFechas(EnumCategoria.enviado,
				LocalDate.of(2020, 5, 1), LocalDate.of(2020, 10, 1)), gestor2);
	}
